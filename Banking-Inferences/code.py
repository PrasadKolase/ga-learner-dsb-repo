...
print("True mean lies in confidance interval :",true_mean>confidence_interval[0] and true_mean<confidence_interval[1])
...
#Code starts here
data['int.rate'] = data['int.rate'].apply(lambda x:x[:-1])

data['int.rate'] = data['int.rate'].apply(lambda x:float(x)/100)
