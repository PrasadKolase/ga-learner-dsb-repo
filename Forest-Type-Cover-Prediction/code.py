...
corr_var_list = correlation[((correlation<lower_threshold) | (correlation>upper_threshold)) & (correlation!=1.0)].values
print(corr_var_list)
# Code ends here
...
dataframe.sort_values(by=['scores'], inplace=True, ascending=False)
